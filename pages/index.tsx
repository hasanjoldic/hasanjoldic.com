    ...
    <>
      ...
      <Box>
        ...
        <Typography>
          ...
          professional carreer I have spent about 60% of my time writing code
          for the web frontend, 30% for the backend, and the rest on other stuff
          like CI/CD.
          <br />
          <br />
          The main thing I bring to the table is the ability to figure things
          out and a methodical aproach to problem solving. I can set up a whole
          web application from scratch, which would include apis, databases,
          CI/CD, backend and frontent apps.
          <br />
          <br />
          Even though I try to have a broad understanding of software
          development, I have a stack in which I&apos;m most productive in:
        </Typography>
        <br />
        ...
        >
          Pethomer connects dog and cat lovers who need help caring for them
          with people who provide such a service (Caregivers). Regardless of
          whether you need: a walk, day care, quick feeding or taking care of a
          pet for a few days as part of the hotel. Pethomer is a place where
          animal lovers (we call them Pethomers) are waiting for the chance to
